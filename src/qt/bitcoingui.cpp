    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("FutureCash"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/futurecash"));
    setWindowIcon(QIcon(":icons/futurecash"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FutureCash address"));
    ...
    aboutAction = new QAction(tr("&About FutureCash"), this);
    aboutAction->setToolTip(tr("Show information about FutureCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FutureCash"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/futurecash"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/futurecash_testnet"));
            setWindowIcon(QIcon(":icons/futurecash_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/futurecash_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FutureCash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FutureCash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FutureCash network", "", count));
}
...
{
    QString strTitle = tr("FutureCash") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FutureCash address or malformed URI parameters."));
    }
